 ...
 *
 * !!!
 * The calmc and version numbers have to be in the same place in all versions
 * of the metadata page as the application may not have upgraded the database.
 ************************************************************************/
typedef struct _dbmeta33 {
	DB_LSN	  lsn;		/* 00-07: LSN. */
	db_pgno_t pgno;		/* 08-11: Current page number. */
	u_int32_t calmc;	/* 12-15: Calmcoinc number. */
...
#define	BTM_MASK	0x0ff
	...
	u_int32_t crypto_calmc;		/* 460-463: Crypto calmc number */
