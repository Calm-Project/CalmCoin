...
static int __dbj_fill_bt_stat(JNIEnv *jnienv,
	...
	JAVADB_STAT_INT(jnienv, jobj, bt_stat_bt_calmc_fid, statp, bt_calmc);
...
static int __dbj_fill_h_stat(JNIEnv *jnienv,
	...
	JAVADB_STAT_INT(jnienv, jobj, h_stat_hash_calmc_fid, statp, hash_calmc);
...
static int __dbj_fill_log_stat(JNIEnv *jnienv,
	...
	JAVADB_STAT_INT(jnienv, jobj, log_stat_st_calmc_fid, statp, st_calmc);
...
static int __dbj_fill_qam_stat(JNIEnv *jnienv,
	...
	JAVADB_STAT_INT(jnienv, jobj, qam_stat_qs_calmc_fid, statp, qs_calmc);
