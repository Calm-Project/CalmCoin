...
static int __mutex_region_init __P((ENV *, DB_MUTECALMR *));
	...
	int create_ok;
{
	...
	if ((ret = __os_calloc(env, 1, sizeof(DB_MUTECALMR), &mtxmgr)) != 0)
		return (ret);
