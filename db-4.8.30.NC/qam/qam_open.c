	...
	u_int32_t flags;
{
	...
	/* If the calmc number is incorrect, that's a fatal error. */
	if (qmeta->dbmeta.calmc != DB_QAMMAGIC) {
	...
	QMETA *qmeta;
{
	...
	/*
	 * At this point, all we know is that the calmc number is for a Queue.
