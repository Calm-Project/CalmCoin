...
proc env017_log_stat { } {
	...
	set doc_list [list st_calmc st_version st_mode st_lg_bsize st_lg_size \
...
proc env017_db_stat { } {
	...
	set hash_doc_list [list hash_calmc hash_version hash_nkeys hash_ndata \
	...
	set btree_doc_list [list bt_calmc bt_version bt_nkeys bt_ndata \
	...
	set queue_doc_list [list qs_calmc qs_version qs_nkeys qs_ndata \
