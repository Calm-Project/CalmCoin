...
#ifndef Q_OS_MAC
    qApp->setWindowIcon(QIcon(":icons/calm"));
    setWindowIcon(QIcon(":icons/calm"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    editConfigFileAction = new QAction(QIcon(":/icons/edit"), tr("Edit calm.conf"), this);
...
void BitcoinGUI::setWalletModel(WalletModel *walletModel)
{
    ...
    if (walletModel)
    {
        ...
        // Client stylesheet
    #ifdef Q_OS_MAC
        QFile qfStyleSheet(":/styles/calm-osx.qss");
    #else
    #if QT_VERSION < 0x050300
        QFile qfStyleSheet(":/styles/calm-qt5.2.qss");
    #else
        QFile qfStyleSheet(":/styles/calm.qss");
    #endif
    #endif
